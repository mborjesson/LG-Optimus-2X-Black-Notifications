...
/**
 * JB-support added by thaitujim
 */

public class TouchLEDF160 extends TouchLED {
    static public final File WLED_FILE = new File("/sys/devices/platform/msm_ssbi.0/pm8921-core/pm8xxx-led/leds/button-backlight/brightness");
