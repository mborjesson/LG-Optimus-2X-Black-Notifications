...
public class TouchLEDMT65XX extends TouchLED {
    static public final File WLED_FILE = new File("/sys/devices/platform/leds-mt65xx/leds/button-backlight/brightness");
