...
public class TouchLEDP920 extends TouchLED {
	static public final File WLED_FILE = new File("/sys/devices/platform/keypad_led/leds/keyboard-backlight/brightness");
